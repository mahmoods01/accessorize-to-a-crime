function physical_impersonation(net_path, main_data_directory, images_directory, impersonator, target)
...
%% Store result
results_file = sprintf('vgg-nn-%d-physical-impersonate-%d.mat', impersonator, target);
